...
* Main background (images/gh.png) - this is the main background image provided via [Unsplash](https://unsplash.com/). This can be kept or changed easily by replacing `images/gh.png` with your new background (recommended size of at least 1920x1080).
